...
<c:choose>
    ...
    <select name="field${field.id}" id="field${field.id}Field${pos}" onchange="insertSelectStringField('${remoteClass}', ${scriptName}, '${classname}','field${field.id}', ${pos},'field${field.id}Field${pos}',${patientId}, ${pregnancyId},'${user}',${siteId},${formId})" style="display:none;">
    ...
    <c:otherwise>
        ...
        <select name="field${field.id}" id="field${field.id}Field${pos}" onchange="insertSelectStringField('${remoteClass}', ${scriptName}, '${classname}','field${field.id}', ${pos},'field${field.id}Field${pos}',${patientId}, ${pregnancyId},'${user}',${siteId})">
            <option value="" selected="selected"> -- </option>
            <option value="Occiput Posterior">OP</option>
            <option value="Right Occiput Posterior">ROP</option>
            <option value="Right Occiput Transverse">ROT</option>
