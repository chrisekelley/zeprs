...
<c:choose>
    ...
    <select name="field${field.id}${pos}" id="field${field.id}" onchange="insertSelectField('${remoteClass}', ${scriptName}, '${classname}','field${field.id}', ${pos},'field${field.id}Field${pos}',${patientId}, ${pregnancyId},'${user}',${siteId},${formId})" style="display:none;">
        <option value=""> -- </option>
    ...
    <c:otherwise>
        ...
        <select name="field${field.id}${pos}" id="field${field.id}" onchange="insertSelectField('${remoteClass}', ${scriptName}, '${classname}','field${field.id}', ${pos},'field${field.id}Field${pos}',${patientId}, ${pregnancyId},'${user}',${siteId},${formId})" style="visibility:hidden; display:none;">
        <option value=""> -- </option>
            <c:forEach var="enum" begin="0" items="${field.enumerations}">
                <c:if test='${enum.enabled ==true}'>
                    <c:choose>
