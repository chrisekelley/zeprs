...
<strong>Date of Visit:</strong> <span class="asterix">*</span>
    ...
    <html:hidden styleId="field1"  styleClass="disabled-date" onfocus="this.blur()" property="field1" value="${yearnow}-${monthnow}-${datenow}"/>
