...
<c:choose>
    ...
    <input type="text" size="${pageItem.size}" maxlength="${pageItem.maxlength}" name="field${field.id}${pos}" id="field${field.id}Field${pos}" onchange="insertInputField('${remoteClass}', ${scriptName}, '${classname}','field${field.id}', ${pos},'field${field.id}Field${pos}',${patientId}, ${pregnancyId},'${user}',${siteId},${formId})"  style="display:none;"/>
    </c:when>
    <c:otherwise>
    <span id="field${field.id}Results${pos}"></span>
    <input type="text" size="${pageItem.size}" maxlength="${pageItem.maxlength}" name="field${field.id}${pos}" id="field${field.id}Field${pos}" onchange="insertInputField('${remoteClass}', ${scriptName}, '${classname}','field${field.id}', ${pos},'field${field.id}Field${pos}',${patientId}, ${pregnancyId},'${user}',${siteId},${formId})"/>
    </c:otherwise>
</c:choose>
