 ...
 * encryptionMethod="none,old_password, password, or whatever encryption method you choose."/>
 */
        ...
        if (userSql == null) {
            ...
            if (encryptionMethod != null) {
        		if (encryptionMethod.equals("none")) {
        			userSql = "SELECT " + userNameCol + " FROM " + userTable + " WHERE " + userTable + "." + userNameCol + " = ? " + " AND " + userCredCol + " = ?";
        		} else {
        			userSql = "SELECT " + userNameCol + " FROM " + userTable + " WHERE " + userTable + "." + userNameCol + " = ? " + " AND " + userCredCol + " = " + encryptionMethod + "(?)";
        		}
        	} else {
    			userSql = "SELECT " + userNameCol + " FROM " + userTable + " WHERE " + userTable + "." + userNameCol + " = ? " + " AND " + userCredCol + " = ?";
        	}
            log.debug("encryptionMethod: " + encryptionMethod + " userSql:" + userSql );
        }
        return userSql;
    }
