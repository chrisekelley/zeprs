...
public class DrugRegimen implements Identifiable, Auditable {

    private Long id;
    private String name;
    private Long regimenType;
    ...
    /**
     * @return
     * @hibernate.property column="regimen_type"
     * not-null="false"
     */
    public Long getRegimenType() {
        return regimenType;
    }

    public void setRegimenType(Long regimenType) {
