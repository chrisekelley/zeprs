...
/**
 * @hibernate.class table="outcome_archive""
 * mutable="true"
 */

public class OutcomeArchive extends AuditInfoLastModifiedComparator implements Identifiable, Auditable, Recordable {
    private Long id;
    ...
    private String uuid;	//uuid of outcome
