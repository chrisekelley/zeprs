...
public class RuleListAction extends BaseAction {
    protected ActionForward doExecute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        // HashMap ruleList = RuleDefinitionDAO.getRuleList();
        // request.setAttribute("ruleList", ruleList);

        // HashMap fieldToPageItems = DynaSiteObjects.getFieldToPageItem();
        // request.setAttribute("fieldToPageItems", fieldToPageItems);
