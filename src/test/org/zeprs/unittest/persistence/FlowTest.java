 ...
 */
public class FlowTest extends ZeprsTest {

    private String listName = "Flows";
    private String name = "Flow";
    private String className = "org.cidrz.webapp.dynasite.valueobject.Flow";
    private String dao = "org.cidrz.webapp.dynasite.dao.FlowDAO";
