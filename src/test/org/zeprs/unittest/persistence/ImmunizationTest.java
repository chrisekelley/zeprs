 ...
 */
public class ImmunizationTest extends ZeprsTest {

    private String listName = "Immunizations";
    private String name = "Immunization";
    private String className = "org.cidrz.project.zeprs.valueobject.Immunization";
    private String dao = "org.cidrz.webapp.dynasite.dao.ImmunizationDAO";
