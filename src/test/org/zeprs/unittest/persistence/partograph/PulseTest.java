 ...
 */
public class PulseTest extends ZeprsTest {

    private String name = "Pulse";
    private String className = "org.cidrz.project.zeprs.valueobject.partograph.Pulse";
    private String dao = "org.cidrz.webapp.dynasite.dao.partograph.PulseDAO";
