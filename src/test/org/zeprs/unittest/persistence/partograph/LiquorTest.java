 ...
 */
public class LiquorTest extends ZeprsTest {

    private String name = "Liquor";
    private String className = "org.cidrz.project.zeprs.valueobject.partograph.Liquor";
    private String dao = "org.cidrz.webapp.dynasite.dao.partograph.LiquorDAO";
