 ...
 */
public class TemperatureTest extends ZeprsTest {

    private String name = "Temperature";
    private String className = "org.cidrz.project.zeprs.valueobject.partograph.Temperature";
    private String dao = "org.cidrz.webapp.dynasite.dao.partograph.TemperatureDAO";
