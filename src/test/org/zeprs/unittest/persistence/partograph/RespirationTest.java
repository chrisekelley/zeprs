 ...
 */
public class RespirationTest extends ZeprsTest {

    private String name = "Respiration";
    private String className = "org.cidrz.project.zeprs.valueobject.partograph.Respiration";
    private String dao = "org.cidrz.webapp.dynasite.dao.partograph.RespirationDAO";
