 ...
 */
public class UrineAmountTest extends ZeprsTest {

    private String name = "UrineAmount";
    private String className = "org.cidrz.project.zeprs.valueobject.partograph.UrineAmount";
    private String dao = "org.cidrz.webapp.dynasite.dao.partograph.UrineAmountDAO";
