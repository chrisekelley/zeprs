 ...
 */
public class DescentTest extends ZeprsTest {

    private String name = "Descent";
    private String className = "org.cidrz.project.zeprs.valueobject.partograph.Descent";
    private String dao = "org.cidrz.webapp.dynasite.dao.partograph.DescentDAO";
