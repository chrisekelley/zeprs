 ...
 */
public class ContractionsTest extends ZeprsTest {

    private String name = "Contractions";
    private String className = "org.cidrz.project.zeprs.valueobject.partograph.Contractions";
    private String dao = "org.cidrz.webapp.dynasite.dao.partograph.ContractionsDAO";
