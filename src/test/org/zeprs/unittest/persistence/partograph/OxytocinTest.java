 ...
 */
public class OxytocinTest extends ZeprsTest {

    private String name = "Oxytocin";
    private String className = "org.cidrz.project.zeprs.valueobject.partograph.Oxytocin";
    private String dao = "org.cidrz.webapp.dynasite.dao.partograph.OxytocinDAO";
