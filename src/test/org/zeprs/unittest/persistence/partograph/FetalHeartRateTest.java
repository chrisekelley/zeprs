 ...
 */
public class FetalHeartRateTest extends ZeprsTest {

    private String listName = "FetalHeartRates";
    private String name = "FetalHeartRate";
    private String className = "org.cidrz.project.zeprs.valueobject.partograph.FetalHeartRate";
    private String dao = "org.cidrz.webapp.dynasite.dao.partograph.FetalHeartRateDAO";
