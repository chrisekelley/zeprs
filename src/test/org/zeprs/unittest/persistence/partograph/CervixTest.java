 ...
 */
public class CervixTest extends ZeprsTest {

    private String name = "Cervix";
    private String className = "org.cidrz.project.zeprs.valueobject.partograph.Cervix";
    private String dao = "org.cidrz.webapp.dynasite.dao.partograph.CervixDAO";
