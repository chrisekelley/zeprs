 ...
 */
public class MouldingTest extends ZeprsTest {

    private String name = "Moulding";
    private String className = "org.cidrz.project.zeprs.valueobject.partograph.Moulding";
    private String dao = "org.cidrz.webapp.dynasite.dao.partograph.MouldingDAO";
