 ...
 */
public class DrugRegimenTest extends ZeprsTest {

    private String listName = "DrugRegimens";
    private String name = "DrugRegimen";
    private String className = "org.cidrz.project.zeprs.valueobject.DrugRegimen";
    private String dao = "org.cidrz.webapp.dynasite.dao.DrugRegimenDAO";
