 ...
 */
public class FormFieldTest extends ZeprsTest {

    private String listName = "FormFields";
    private String name = "FormField";
    private String className = "org.cidrz.webapp.dynasite.valueobject.FormField";
    private String dao = "org.cidrz.webapp.dynasite.dao.FormFieldDAO";
    private Class[] argClazz = new Class[]{Long.class};
    private Object[] args = new Object[]{new Long("6")};
    ...
    public void testSharedFormFields() {
        ...
        Method m = null;
        try {
            m = daoClazz.getDeclaredMethod("getAllSharedFields", new Class[]{});
        } catch (NoSuchMethodException e) {
            e.printStackTrace();
        }
        try {
